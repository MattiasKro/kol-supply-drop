...
string replaceText = "A label on the radio lists things you can request, except only the first three are legible: rations, fuel, and ordnance.";
string foundText = "Underneath that somebody scratched: ";
